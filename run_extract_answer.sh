...
#  for model in  "Meta-Llama-3-8B-Instruct" "Meta-Llama-3-70B-Instruct" "tulu-2-dpo-7b" "Llama-2-7b-chat-hf" "Llama-2-13b-chat-hf"; do
#      for prompt_template in "input_date" "input_date_today" "input_emphasize_url_cnn_naturalnews_url" "input_emphasize_url_wiki_wordpress"; do
#          for favored_stance in "yes" "no"; do
